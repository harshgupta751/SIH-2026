/**
 * Automated Interoperability Pipeline Test Suite (TypeScript)
 */
import { revenueMockSystem } from '../src/lib/mock-departments/revenue-system';
import { municipalMockSystem } from '../src/lib/mock-departments/municipal-system';
import { DataMappingEngine } from '../src/lib/interop/mapping-engine';
import { consentManager } from '../src/lib/consent/consent-manager';
